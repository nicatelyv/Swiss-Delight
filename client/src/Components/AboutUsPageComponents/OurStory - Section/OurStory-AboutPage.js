...
function OurStoryAboutPage() {
    return (
        <section className='AboutOurstorySection'>
            <div className='abt_os_main'>
                <div className='abt_os_texts'>
                    <h6 id='abt_os_h6'>GERÇEK TAT</h6>
...
export default OurStoryAboutPage